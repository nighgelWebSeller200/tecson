document.addEventListener("DOMContentLoaded", () => {
    ...
    function hideAllSections() {
      ...
      buttons.forEach((button) => {
        button.style.backgroundColor = "#daa520"; // Reset to light blue
    ...
    function styleButton(button) {
      button.style.backgroundColor = "#daa520"; // Light blue background
      button.style.color = "#000000"; // Black font color
    ...
    function createButton(button, label, section) {
      ...
      button.addEventListener("click", () => {
        ...
        button.style.backgroundColor = "#daa520"; // White background when active
        button.style.color = "#0000ff"; // Black font when active
        button.style.justifyContent = 'center';
      });
